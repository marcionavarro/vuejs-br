<template>
  <div class="flex justify-between">
    <h1 class="text-4xl font-black text-gray-800 focus:outline:none">
      Crie uma conta
    </h1>
    <button
      @click="close"
    ...
    <form @submit.prevent="handleSubmit">
      <label class="block">
        ...
        <input
          ...
          class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 rounded focus:outline-none"
